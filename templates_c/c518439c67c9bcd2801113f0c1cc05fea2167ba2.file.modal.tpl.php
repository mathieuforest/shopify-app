<?php /* Smarty version Smarty 3.1.4, created on 2016-12-01 14:41:14
         compiled from "templates/modal.tpl" */ ?>
<?php /*%%SmartyHeaderCode:59471721058407cda347fa8-43930274%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '59471721058407cda347fa8-43930274',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty 3.1.4',
  'unifunc' => 'content_58407cda3c418',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58407cda3c418')) {function content_58407cda3c418($_smarty_tpl) {?><div class="refund-modal">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="exampleModalLabel">Refund Payments</h4>
                </div>
                <div class="modal-body">

                    <form tg-remote="true" refresh-on-success="modal timeline_container order-line-items order-notices order-actions ui-modal-contents" refresh-on-error="modal timeline_container order-line-items order-notices order-actions ui-modal-contents" submit-on-cmd-enter="true" define="" autocomplete="off" action="/admin/orders/4473151633/refunds" accept-charset="UTF-8" method="post">
                        <input name="utf8" type="hidden" value="✓">
                        <input type="hidden" name="authenticity_token" value="lOCnOWdvoyzAHyspNlcwGx6NcwC772DtVNbpG/qRMMGzz+brQDr4B7m8kLgEwl9nDDqyPU/GnMZNs1B28p9p1w==">
                        <div class="body">
                            <div style="padding-right: 12px;">
                                <div class="table-wrapper">
                                    <table class="next-table--line-items next-table--with-price">
                                        <tbody>
                                        <tr context="refundItems[8615283921]">
                                            <td class="next-table__cell--item-name" width="45%">
                                                <a href="/admin/products/8320544913/variants/27843702481">test</a>


                                                <p><small class="status error">This product cannot be restocked</small></p>
                                            </td>
                                            ...
                                            <td class="tr">
                <span define="">
                  <input name="refund[refund_line_items][][line_item_id]" type="text" class="hide" value="8615283921">
                  <input name="refund[refund_line_items][][quantity]" bind="quantity" class="j-refund-quantity" type="number" min="0" max="1" value="0">
                </span>
                                            </td>

                                            <td class="type--right" define="">
                                                <span bind-unsafe-html="refundTotal" bind-show="!pendingRefundCalculation">$0.00</span>

                                                <div class="next-spinner sr hide" bind-show="pendingRefundCalculation">
                                                    <svg class="next-icon next-icon--size-20"> <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-spinner"></use> </svg>
                                                </div>
                                            </td>
                            ...
                            <div class="table-wrapper">
                                <table class="refund-payments">
                                    <tbody><tr context="refundableTransactions[5204215377]">
                                        <td>
                                        ...
                                        <td class="tr" define="">
                                            ...
                                            <input name="refund[transactions][][order_id]" class="hide" value="4473151633" type="text">
